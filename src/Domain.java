...
final class User {
    ...
    User(String userId, String password, String displayName, Role role, UserStatus status, int sourceLine) {
        this.userId = userId;
    ...
    String toRecord() {
        return String.join("|", "USER", userId, password, displayName, role.fileValue(), status.name());
    }
}
...
final class Room {
    ...
    Room(String roomId, String roomName, int maxCapacity, String equipmentList, RoomStatus roomStatus, int sourceLine) {
        this.roomId = roomId;
    ...
    String toRecord() {
        return String.join("|", "ROOM", roomId, roomName, Integer.toString(maxCapacity), equipmentList, roomStatus.name());
    }
}
